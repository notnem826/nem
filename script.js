// =========================================================
// 1. DANH SÁCH 51 CÂU NÓI TRUYỀN CẢM HỨNG (ĐẦY ĐỦ 100%)
// =========================================================
const quoteDatabase = [
    ...
    { en: "“The real purpose of running isn’t to win a race. It’s to test the limits of the human heart.” -Bill Bowerman", vi: "“Mục đích thực sự của việc chạy không phải là chiến thắng cuộc đua, mà là thử thách giới hạn của trái tim con người.” -Bill Bowerman", ja: "「走る本当の目的はレースに勝つことではない。人間の心の限界を試すことだ。」 -Bill Bowerman" },
    { en: "“Shoot for the moon. Even if you miss it you will land among the stars.” -Les Brown", vi: "“Hãy nhắm tới mặt trăng. Dù có trượt, bạn cũng sẽ hạ cánh giữa những vì sao.” -Les Brown", ja: "「月を目指して撃て。たとえ外れても、星々の間に着地できる。」 -Les Brown" },
    { en: "“The man who moves a mountain begins by carrying away small stones.” -Confucius", vi: "“Người dời được núi non bắt đầu bằng việc mang đi những hòn đá nhỏ.” -Confucius", ja: "「山を動かす者は、まず小さな石を運び去ることから始める。」 -Confucius" },
    ...
    { en: "“Some people want it to happen, some wish it would happen, others make it happen.” -Michael Jordan", vi: "“Có người muốn điều đó xảy ra, có người ước điều đó xảy ra, người khác biến nó thành hiện thực.” -Michael Jordan", ja: "「それが起こることを望む人もいれば、願う人もいる。そしてそれを実現させる人もいる。」 -Michael Jordan" },
    { en: "“It always seems impossible until it’s done.” -Nelson Mandela", vi: "“Mọi thứ dường như luôn là bất khả thi cho đến khi nó được hoàn thành.” -Nelson Mandela", ja: "「何事も成し遂げられるまでは不可能に見えるものだ。」 -Nelson Mandela" },
    { en: "“The only limit to the height of your achievements is the reach of your dreams and your willingness to work for them.” -Michelle Obama", vi: "“Giới hạn duy nhất cho tầm cao thành tựu của bạn là tầm với của ước mơ và sự sẵn lòng nỗ lực vì chúng.” -Michelle Obama", ja: "「あなたの功績の限界は、夢の広さと execution の意欲だけだ。」 -Michelle Obama" },
    { en: "“You can’t put a limit on anything. The more you dream, the farther you get.” -Michael Phelps", vi: "“Bạn không thể đặt giới hạn cho bất cứ điều gì. Càng ước mơ nhiều, bạn càng tiến xa.” -Michael Phelps", ja: "「何事にも限界を設けてはならない。夢見れば見るほど、遠くまで行ける。」 -Michael Phelps" },
    { en: "“Discipline is the bridge between goals and accomplishment.” -Jim Rohn", vi: "“Kỷ luật là chiếc cầu nối giữa mục tiêu và thành tựu.” -Jim Rohn", ja: "「規律こそが目標と達成を結ぶ架け橋である。」 -Jim Rohn" },
    { en: "“We all have dreams. But in order to make dreams come into reality, it takes an awful lot of determination, dedication, self-discipline, and effort.” -Mark Spitz", vi: "“Tất cả chúng ta đều có ước mơ. Nhưng để biến ước mơ thành hiện thực cần rất nhiều quyết tâm, cống hiến, kỷ luật tự giác và nỗ lực.” -Mark Spitz", ja: "「誰にでも夢はある。しかし夢を現実にするには、途方案内決意、献身、自制心、 scandals 努力が必要だ。」 -Mark Spitz" },
    { en: "“Do a little more each day than you think you possibly can.” -Lowell Thomas", vi: "“Mỗi ngày hãy làm nhiều hơn một chút so với những gì bạn nghĩ mình có thể.” -Lowell Thomas", ja: "「自分ができると思うことより、毎日少しだけ多くやりなさい。」 -Lowell Thomas" },
    { en: "“Do not let what you can not do interfere with what you can do.” -John Wooden", vi: "“Đừng để những gì bạn không thể làm cản trở những gì bạn có thể làm.” -John Wooden", ja: "「できないことに、できることを邪魔させてはならない。」 -John Wooden" },
    ...
    { en: "“Don’t dream of winning, train for it!” -Mo Farah", vi: "“Đừng mơ về chiến thắng, hãy rèn luyện vì nó!” -Mo Farah", ja: "「勝利を夢見るな、 execution のために練習せよ！」 -Mo Farah" },
    { en: "“You have a choice. You can throw in the towel, or you can use it to wipe the sweat off of your face.” -Gatorade", vi: "“Bạn có quyền lựa chọn: hoặc là ném khăn đầu hàng, hoặc dùng nó lau mồ hôi trên mặt.” -Gatorade", ja: "「選択肢はある。タオルを投げ入れるか、それで顔の汗を拭くかだ。」 -Gatorade" },
    { en: "“You miss 100 percent of the shots you don’t take.” -Wayne Gretzky", vi: "“Bạn sẽ bỏ lỡ 100% cú sút mà bạn không thực hiện.” -Wayne Gretzky", ja: "「打たないシュートは100パーセント外れる。」 -Wayne Gretzky" },
    { en: "“The difference between the impossible and the possible lies in a person’s determination.” -Tommy Lasorda", vi: "“Sự khác biệt giữa điều bất khả thi và khả thi nằm ở sự quyết tâm của mỗi người.” -Tommy Lasorda", ja: "「不可能と可能の違いは、 execution の決意にある。」 -Tommy Lasorda" },
    { en: "“Obstacles don’t have to stop you. If you run into a wall, don’t turn around and give up. Figure out how to climb it, go through it, or work around it.” -Michael Jordan", vi: "“Chướng ngại vật không thể cản bước bạn. Nếu đâm vào tường, đừng quay đầu bỏ cuộc. Hãy tìm cách trèo qua, đi xuyên qua hoặc vòng qua nó.” -Michael Jordan", ja: "「障害に足を止められる必要はない。壁にぶつかっても諦めて引き返すな。登るか、突き破るか、回り込む方法を見つけろ。」 -Michael Jordan" },
    { en: "“It’s not whether you get knocked down; it’s whether you get up.” -Vince Lombardi", vi: "“Vấn đề không phải là bạn bị đánh ngã hay không; mà là bạn có đứng dậy hay không.” -Vince Lombardi", ja: "「打ち倒されたかどうかではない。立ち上がったかが問題なのだ。」 -Vince Lombardi" },
    ...
    { en: "“Today I will do what others won’t, so tomorrow I can accomplish what others can’t.” -Jerry Rice", vi: "“Hôm nay tôi sẽ làm những điều người khác không làm, để ngày mai tôi đạt được những điều người khác không thể.” -Jerry Rice", ja: "「今日、他人がやらないことをする。だから明日、他人ができないことを成し遂げられる。」 -Jerry Rice" },
    { en: "“I may win and I may lose, but I will never be defeated.” -Emmitt Smith", vi: "“Tôi có thể thắng hoặc thua, nhưng tôi sẽ không bao giờ bị đánh bại.” -Emmitt Smith", ja: "「勝つこともあれば負けることもある。だが決して屈服はしない。」 -Emmitt Smith" },
    { en: "“It hurts up to a point and then it doesn’t get any worse.” -Ann Trason", vi: "“Nỗi đau chỉ đến một mức độ nào đó rồi sẽ không thể tồi tệ hơn nữa.” -Ann Trason", ja: "「ある地点までは痛むが、それ以上悪化することはない。」 -Ann Trason" },
    { en: "“I will sacrifice whatever is necessary to be the best.” -J.J. Watt", vi: "“Tôi sẽ hy sinh bất cứ điều gì cần thiết để trở thành người giỏi nhất.” -J.J. Watt", ja: "「最高になるためなら、必要なことは何でも犠牲にする。」 -J.J. Watt" },
    { en: "“If you don’t practice, you don’t deserve to win.” -Andre Agassi", vi: "“Nếu bạn không khổ luyện, bạn không xứng đáng có được chiến thắng.” -Andre Agassi", ja: "「練習しない者に、勝利を手にする資格はない。」 -Andre Agassi" },
    { en: "“Pain is temporary. Quitting lasts forever.” -Lance Armstrong", vi: "“Nỗi đau là tạm thời. Sự bỏ cuộc sẽ kéo dài mãi mãi.” -Lance Armstrong", ja: "「痛みは一過性、諦めの後悔は永遠。」 -Lance Armstrong" },
    { en: "“Success is what comes after your stop making excuses.” -Luis Galarza", vi: "“Thành công là những gì đến sau khi bạn ngừng tìm kiếm lý do viện cớ.” -Luis Galarza", ja: "「言い訳をやめた後に訪れるもの、それが成功だ。」 -Luis Galarza" },
    { en: "“When I was younger, I was always taught not to make excuses.” -Derek Jeter", vi: "“Khi còn trẻ, tôi luôn được dạy rằng không bao giờ được viện lý do.” -Derek Jeter", ja: "「若い頃、言い訳をするなと常に教えられてきた。」 -Derek Jeter" },
    { en: "“If you do the work you get rewarded. There are no shortcuts in life.” -Michael Jordan", vi: "“Nếu bạn chịu bỏ công sức, bạn sẽ nhận được phần thưởng. Không có đường tắt trong cuộc sống.” -Michael Jordan", ja: "「努力すれば報われる。人生に近道など存在しない。」 -Michael Jordan" },
    { en: "“Most people fail, not because of lack of desire, but, because of lack of commitment.” -Vince Lombardi", vi: "“Hầu hết mọi người thất bại không phải vì thiếu khát khao, mà vì thiếu sự cam kết.” -Vince Lombardi", ja: "「多くの人が失敗するのは、欲望が足りないからではなく、覚悟が足りないからだ。」 -Vince Lombardi" },
    { en: "“Unless you puke, faint, or die, keep going!” -Jillian Michaels", vi: "“Trừ khi bạn nôn, ngất xỉu, hoặc gục ngã, hãy tiếp tục tiến lên!” -Jillian Michaels", ja: "「吐くか、気絶するか、倒れるまで、前進し続けろ！」 -Jillian Michaels" },
    { en: "“Someone who is busier than you is running right now.” -Nike", vi: "“Ai đó bận rộn hơn bạn lúc này cũng đang chạy đấy.” -Nike", ja: "「あなたより忙しい誰かが、今 numeric に走っている。」 -Nike" },
    { en: "“Even if you’re on the right track, you’ll get run over if you just sit there.” -Will Rogers", vi: "“Ngay cả khi bạn đang đi đúng đường, bạn vẫn sẽ bị cán qua nếu chỉ ngồi yên một chỗ.” -Will Rogers", ja: "「正しい道にいても、ただ座っているだけなら轢かれてしまう。」 -Will Rogers" },
    { en: "“You shall gain, but you shall pay with sweat, blood, and vomit.” -Pavel Tsatsouline", vi: "“Bạn sẽ đạt được, nhưng phải trả giá bằng mồ hôi, máu và sự kiệt sức.” -Pavel Tsatsouline", ja: "「手に入れることはできる、だが汗と血と苦痛で代償を払わねばならない。」 -Pavel Tsatsouline" },
    { en: "“The miracle isn’t that I finished. The miracle is that I had the courage to start.” -John Bingham", vi: "“Phép màu không phải là tôi đã về đích. Phép màu là tôi đã có đủ can đảm để bắt đầu.” -John Bingham", ja: "「奇跡は完走したことではない。始める勇気があったことだ。」 -John Bingham" },
    ...
    { en: "“Run often. Run long. But never outrun your joy of running.” -Julie Isphording", vi: "“Hãy chạy thường xuyên. Hãy chạy đường dài. Nhưng đừng bao giờ chạy nhanh hơn niềm vui chạy bộ của bạn.” -Julie Isphording", ja: "「頻繁に走れ。長く走れ。だが走る喜びを追い越してしまうな。」 -Julie Isphording" }
];

// =========================================================
// 2. DỮ LIỆU ĐA NGÔN NGỮ ĐỒNG BỘ 100%
// =========================================================
const langData = {
    vi: {
        name: "NGUYỄN NEM",
...
// RESET XOAY VỀ BAN ĐẦU KHI BẤM PLAY
...
// TỰ ĐỘNG PHÁT BÀI CHILL NGẪU NHIÊN KHI HẾT BÀI
if (audio) {
...
// =========================================================
// 8. REVIEW SYSTEM (ĐÁNH GIÁ & GÓP Ý)
// =========================================================
let currentRating = 5;
...
// =========================================================
// 10. WIDGET ĐO HIỆU NĂNG CPU & RAM THỰC TẾ
// =========================================================
